# Percentage changes and Correlations
...
HPI_state_correlation = HPI_data.corr() # Gives you a correlation matrix
HPI_state_correlation.describe() # Gives you a bunch of descriptive stats on the data

# Note that to gget your correlation matrix in excel you can send it to csv and open with excel
